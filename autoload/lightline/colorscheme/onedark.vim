...
let s:cyan = [ s:colors.cyan.gui, s:term_green ]
...
let s:p.normal.left = [ [ s:blue, s:black ], [ s:white, s:black ] ]
...
let s:p.insert.left = [ [ s:green, s:black ], [ s:white, s:black ] ]
let s:p.insert.right = [ [ s:white, s:black ], [ s:white, s:black ] ]
let s:p.replace.left = [ [ s:red, s:black ], [ s:white, s:black ] ]
let s:p.replace.right = [ [ s:white, s:black ], [ s:white, s:black ] ]
let s:p.visual.left = [ [ s:purple, s:black ], [ s:white, s:black ] ]
